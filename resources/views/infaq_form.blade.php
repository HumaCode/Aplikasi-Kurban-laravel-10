            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        {!! Form::select('sumber', $listSumber, null, ['class' => 'form-control', 'placeholder' =>
                        '-- Pilih --']) !!}
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            {!! Form::radio('jenis', 'uang', 1, ['class' => 'form-check-input', 'id' =>
                            'uang']) !!}
                            {!! Form::label('uang', 'Uang', ['class' => 'form-check-label']) !!}
                        </div>
                        <div class="form-check">
                            {!! Form::radio('jenis', 'barang', null, ['class' => 'form-check-input', 'id' =>
                            'barang']) !!}
                    ...
                    <div class="mb-3">
                        {!! Form::label('satuan', 'Satuan Jumlah - Misal: Kg, rupiah, atau sak untuk semen', ['class' =>
                        'form-label']) !!}
