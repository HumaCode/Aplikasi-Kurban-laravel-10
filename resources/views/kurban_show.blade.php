            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('kurban.show', [
                            $model->id,
                            'output' => 'laporan',
                            ]) }}" target="_blank" class="fw-2"><i class="align-middle" data-feather="file-text"></i>
                            &nbsp;
                            Laporan
                            Peserta Kurban</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <span class="badge badge-pill badge-success">{{ $item->getStatusText() }}</span>
                                        @else
                                        <span class="badge badge-pill badge-danger">{{ $item->getStatusText() }}</span>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('kurbanpeserta.edit', [$item->id, 'kurban_id' => $item->kurban_id]) }}"
                                            class="btn btn-success btn-sm "><i class="fas fa-money-bill-wave"></i></a>

                                        {!! Form::open([
                                        'method' => 'DELETE',
                                        'route' => ['kurbanpeserta.destroy', [$item->id, 'kurban_id' =>
                                        $item->kurban_id]],
                                        'style' => 'display:inline',
                                        ]) !!}
