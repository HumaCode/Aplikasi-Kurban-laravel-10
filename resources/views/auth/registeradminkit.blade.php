...
<head>
    ...
    <title>{{ config('app.name') }} | Halaman Register</title>
                ...
                <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="text-center mt-4">
                            <h1 class="h2">Daftar {{ config('app.name') }}</h1>
                            <p class="lead">
                                Daftar Sekarang juga, anda dapat mengontrol keuangan masjid dari aplikasi ini
                            </p>
                        </div>
